...
class LanguageProvider extends ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _strings = {
    'ar': {
      ...
      'symbol_hint': 'مثلاً: BTCUSDT, EURUSD, XAUUSD',
      ...
      'connected_success': 'تم الاتصال بالخادم بنجاح! المحرك والذكاء الاصطناعي متصلان.',
      'connection_failed': 'فشل الاتصال بالخادم. تأكد من أن الـ Backend يعمل على هذا العنوان.',
    },
    'en': {
      'app_title': 'Smart Trader AI',
      'server_connected': 'AI Analysis Engine is Online',
      'server_disconnected': 'Connecting or Reconnecting to Cloud',
      'scan_card_title': 'Smart Chart Analysis with AI',
      'scan_card_subtitle': 'Upload a chart screenshot to analyze trends, patterns, entries, and target levels with high precision.',
      'start_scan_button': 'Scan / Upload Chart',
      'shield_title': 'Strict Anti-Misleading Protection System',
      'shield_desc': 'The model does not hallucinate prices. It calculates mathematical indicators (RSI, ATR) in real time from live market data.',
